...
const DistressMessageList = React.lazy(() => import('./pages/DistressMessages/DistressMessageList'));
const DistressMessageDetail = React.lazy(() => import('./pages/DistressMessages/DistressMessageDetail'));
const CreateDistressMessage = React.lazy(() => import('./pages/DistressMessages/CreateDistressMessage'));
const EditDistressMessage = React.lazy(() => import('./pages/DistressMessages/EditDistressMessage'));
