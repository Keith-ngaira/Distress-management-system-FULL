  ...
  myCases: [
    {
      ...
      director_instructions:
        "Expedite humanitarian aid delivery - work with NGO partners. Maintain regular communication and document all progress.",
    ...
    },
    {
      ...
      director_instructions:
        "Security protocols must be followed. Coordinate with local authorities.",
      last_update: "2024-01-08T17:20:00Z",
      completed_date: "2024-01-08T17:20:00Z",
      resolution_notes:
        "All clear - suspicious package confirmed safe. Excellent response time and coordination.",
    },
    {
      id: 9,
      folio_number: "DM012",
      ...
      director_instructions:
        "Deploy search and rescue team immediately. Weather conditions critical.",
      last_update: null,
    },
  ],
  trainingModules: [
  ...
  recentFeedback: [
    {
      ...
      comment:
        "Excellent coordination with NGO partners. Response was timely and well-documented. Continue this level of performance.",
      rating: "Excellent",
    ...
    },
    {
      ...
      comment:
        "Quick response and effective communication with local authorities. Well handled under pressure.",
      rating: "Good",
    ...
    },
    {
      ...
      comment:
        "Consistent improvement in case handling and documentation. Focus on reducing response times further.",
      rating: "Good",
      reviewer: "Director Michael",
